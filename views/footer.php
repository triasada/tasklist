...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    $('#isikiri').append("<h3>Project List</h3><br>");
    ...
    default:
        ...
        break;
                       ...
                       $('#isikiri').append("<h4 class='"+colorijo+"'>"+newdata[i].project+"  ("+newdata[i].taskall+" task)</h4>");
                       var percent = Math.round(100*newdata[i].taskdone/newdata[i].taskall)
                       if (!percent){percent = 0}
                        $('#isikiri').append(" <div class='progress'><div class='progress-bar-success' role='progressbar' aria-valuenow='"+percent+"' aria-valuemin='0' aria-valuemax='100' style='width:"+percent+"%'>\n\
